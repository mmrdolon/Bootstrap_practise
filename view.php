    ...
    <div class="sidebar-menu">
        ...
        <ul id="main-menu" class="">
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="list1.php"><i class="entypo-users"></i><span>All Users</span></a>
                    </li>
                    <li>
                        <a href="edit_user.html"><i class="entypo-user-add"></i><span></span></a>
                    </li>
                    <li>
                        <a href="#"><i class="entypo-key"></i><span></span></a>
                    </li>
                </ul>
