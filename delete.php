...
$link = mysqli_connect("localhost",
    ...
    "",
    "personal_website");
$query = "DELETE FROM `personal_website`.`user` WHERE `user`.`id` = $id";
...
?>
        ...
        <h2 class="text-success">Your Information Or Data Is Successfully deleted</h2>
        <a href="list1.php"><b>Show List...</b></a>
